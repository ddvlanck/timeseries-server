...
var RawData = /** @class */ (function (_super) {
    ...
    RawData.prototype.setupPollInterfaces = function () {
        ...
        this.commMan.router.get('/' + this._name + '/fragments', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
            var queryTime, fragments, _a, fragment, index, fc, st, staticTriples, modFragment, ft, fragmentTriples, metaData;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Utils.getTriplesFromFile(this._fragmentsPath + '/' + modFragment + ".trig")];
                    case 3:
                        ft = _b.sent();
